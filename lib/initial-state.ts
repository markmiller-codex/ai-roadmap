...
export function createEmptyAssessment(now = new Date().toISOString()): Assessment {
  return {
    ...
    websiteDiscovery:{status:"not_started",companyName:"",industry:"",businessDescription:"",services:[],customerSegments:[],locations:[],revenueModelClues:[],leadershipClues:[],hiringSignals:[],technologyMentioned:[],likelyBusinessFunctions:[],likelyWorkflows:[],complianceConstraints:[],sourceUrls:[],rejectedFactLabels:[],correctedFields:[]}, businessCalibration:{status:"not_started",industryKey:"",answers:{}}, expectedWorkflowReviews:[], capturedFacts: [], discoveryIssues: [], operating_metrics: [], business_functions: [], role_groups: [], workflows: [], technology_stack: [], data_assets: [], document_assets: [], pain_points: [],
