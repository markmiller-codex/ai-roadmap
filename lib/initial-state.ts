...
export function createEmptyAssessment(now = new Date().toISOString()): Assessment {
  return {
    ...
    company_profile: { company_name: "", industry: "", subindustry: "", locations: null, employee_count: null, annual_revenue: null, years_in_business: null, customer_types: [], revenue_sources: [], operating_model: "", management_structure: "", strategic_priorities: [], current_business_pressures: [] },
    business_functions: [], role_groups: [], workflows: [], technology_stack: [], data_assets: [], document_assets: [], pain_points: [],
    ...
    opportunities: [], roadmap_phases: [], answers: [],
  };
}
