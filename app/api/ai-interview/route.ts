...
export async function POST(request: Request) {
  ...
  if (!apiResponse.ok) return NextResponse.json({ error:"OpenAI request was not successful.", fallback:true }, { status:502 });
